...
// Fetch existing team lead details
$query = "SELECT * FROM users WHERE id = $user_id AND role = 'team_lead'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($errors)) {
        ...
        if (mysqli_query($conn, $update_query)) {
            $success = 'Team Lead updated successfully!';
            // Refresh data
            $result = mysqli_query($conn, $query);
            $user = mysqli_fetch_assoc($result);
            $form_data = $user;
        } else {
            $error = 'Error updating team lead: ' . mysqli_error($conn);
        }
    }
}
?>
...
<head>
    ...
    <title><?php echo $company_name; ?> - Edit Team Lead</title>
...
<body>
        ...
        <nav class="navbar-top">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center w-100">
                    <div>
                        <h4 class="mb-0">Edit Team Lead</h4>
                        <small class="text-muted">Update team lead account information</small>
                    </div>
                    <div>
        ...
        <div class="form-container">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Update Account Details</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="" id="editTeamLeadForm">
                        <div class="row">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Update Team Lead
                            </button>
                        </div>
                    </form>
                </div>
    ...
    <script>
        ...
        // Form validation
        document.getElementById('editTeamLeadForm').addEventListener('submit', function(e) {
