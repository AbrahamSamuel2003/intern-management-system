...
$query = "SELECT * FROM domains WHERE id = $domain_id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($domain_name)) {
        ...
        $check_query = "SELECT id FROM domains WHERE domain_name = '$domain_name' AND id != $domain_id";
        ...
        if (mysqli_num_rows($check_result) > 0) {
            ...
            // Update domain
            $update_query = "UPDATE domains SET domain_name = '$domain_name', description = '$description' WHERE id = $domain_id";
            
            if (mysqli_query($conn, $update_query)) {
                $success = 'Domain updated successfully!';
            } else {
                $error = 'Error updating domain: ' . mysqli_error($conn);
            }
        }
    }
}
...
<head>
    ...
    <title><?php echo $company_name; ?> - Edit Domain</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center w-100">
                    <div>
                        ...
                        <small class="text-muted">Update domain information</small>
                    </div>
                    <div>
        ...
        <div class="form-container">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Domain Details</h5>
                </div>
                <div class="card-body">
